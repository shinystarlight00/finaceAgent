      ...
      <div>
        ...
        >
          <li className="sidebar-li">
            ...
            <Link to="/merge-excel" style={{ textDecoration: "none" }}>
              Merge Excel GPT
            </Link>
          </li>
          <li className="sidebar-li">
          ...
          <li className="sidebar-li">
            ...
            <Link to="/data-cleaning" style={{ textDecoration: "none" }}>
              Data Cleaning GPT
            </Link>
          </li>
          <li className="sidebar-li">
            ...
            />
            <Link to="/cohort-analysis" style={{ textDecoration: "none" }}>
              Cohort Analysis GPT
            </Link>
          </li>
          <li className="sidebar-li">
            <CircleIcon
              ...
              style={{ marginRight: "10px" }}
            />
            <Link to="/outliers" style={{ textDecoration: "none" }}>
              Outliers GPT
            </Link>
          </li>
        </ul>
